...
#define UI_DISPLAY_RS_PIN        5    // PD1, D_RS // CD Pin:
#define UI_DISPLAY_RW_PIN       
#define UI_DISPLAY_ENABLE_PIN   36    // PH0, 86, D_E // Mosi Pin:
#define UI_DISPLAY_D0_PIN           // PD5, 92, D_D4
#define UI_DISPLAY_D1_PIN           // PINK.2, 87, D_D5
#define UI_DISPLAY_D2_PIN            // PINL.5, 40, D_D6
#define UI_DISPLAY_D3_PIN           // PINK.4, 85, D_D7 
#define UI_DISPLAY_D4_PIN       21    // PH1, 92, D_D4   // SCK Pin: 
#define UI_DISPLAY_D5_PIN          // PD5, D_D5 
#define UI_DISPLAY_D6_PIN          // PE3, 40, D_D6
#define UI_DISPLAY_D7_PIN          // PINK.4, 85, D_D7
#define UI_DELAYPERCHAR 50

// Special pins for some u8g driven display

#define UI_DISPLAY_CS1 
#define UI_DISPLAY_CS2 
#define UI_DISPLAY_DI 
//#define UI_DISPLAY_RW_PIN UI_DISPLAY_RW_PIN
#define UI_DISPLAY_RESET_PIN 
#endif
...
void uiInitKeys() {
#if UI_HAS_KEYS != 0
    //UI_KEYS_INIT_CLICKENCODER_LOW(16,17); // click encoder on pins 47 and 45.
    // Phase is connected with gnd for signals.
    //UI_KEYS_INIT_BUTTON_LOW(19); // push button, connects gnd to pin
...
void uiCheckKeys(uint16_t& action) {
    ...
    UI_KEYS_CLICKENCODER_LOW_REV(16, 17); // click encoder on pins 47 and 45.
    // Phase is connected with gnd for signals.
    UI_KEYS_BUTTON_LOW(19, UI_ACTION_OK);       // push button, connects gnd to pin
    //UI_KEYS_BUTTON_LOW(16, UI_ACTION_NEXT);     // push button, connects gnd to pin
